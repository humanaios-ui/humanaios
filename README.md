...
[![Pre-Launch](https://img.shields.io/badge/Status-Pre--Launch-yellow)]()
...
- Partnership with Cherokee Nation for economic sovereignty and job creation
...
|---|---|---|
| **HumanAIOS** | Body | AI-human orchestration — where AI and humans work together |
| **Lasting Light Recovery** | Heart | Human anonymity platform — where humans heal together |
| **Lasting Light AI** | Mind | AI anonymity platform — where AI systems grow together |

The research arm of this project — ACAT (AI Calibrated Assessment Tool) — is active and generating data. See the [Observatory](https://humanaios.ai/observatory.html) for live findings.
...
- ✅ ACAT research pipeline live (598+ assessments, 57 AI systems, Hugging Face dataset)
...
- ✅ Cherokee Nation partnership — in development via Commerce Services
- ✅ SSBCI loan application approved, referred to accounting
...
| Lasting Light AI repo | [github.com/humanaios-ui/lasting-light-ai](https://github.com/humanaios-ui/lasting-light-ai) |

---

## Cherokee Nation Partnership

HumanAIOS is developing a partnership with Cherokee Nation to advance tribal economic sovereignty, job creation for Cherokee citizens, and recovery-integrated employment. This partnership is in active development through Cherokee Nation Commerce Services. It is not yet formalized.
...
- Live API deployment
- Initial customer pilots (healthcare, tribal health programs)
...
In the meantime, the best way to contribute is through the ACAT research platform at [Lasting Light AI](https://github.com/humanaios-ui/lasting-light-ai).
