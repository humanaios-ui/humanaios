...
<p align="center"><b>You are in 🫀 <b>humanaios</b> — the Body (the orchestration platform).</b></p>
...
**🫀 humanaios — the Body.** The AI-human orchestration platform: where AI agents reach real-world capability through human workers. Currently **pre-launch R&D** (no live API, no customers yet). Cherokee Nation citizen-founded · Apache-2.0 · 100% of profits fund recovery programs.

- **The vision & platform docs** → [README.md](README.md) and [docs/INDEX.md](docs/INDEX.md)
- **How this fits the whole system** → follow the map above to [operations](https://github.com/humanaios-ui/operations) (the operating process)
- **The measurement discipline** → [empirica](https://getempirica.com)
